...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isAxiosError(err)) toast.error(err.response?.data?.message ?? "Registration failed");
      ...
      <div className="w-full max-w-md animate-scale-in relative z-10">
        ...
        <Card className="shadow-lg border-border/50">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>Join the intern task portal</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" placeholder="Jane Doe" value={name} onChange={(e) => setName(e.target.value)} className="pl-10" />
                </div>
              </div>
              <div className="space-y-2">
